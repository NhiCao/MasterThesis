...
%
\etitle{Data Evaluation and Cleaning for Improving TTS Voices Trained on Crowdsourced Datasets}
\eauthor{CAO Hai Nhi}
% キーワード５-６個 (in LaTeX)
\ekeywords{speech synthesis, data evaluation, data cleaning, crowdsourced datasets}
%
% 内容梗概 (in LaTeX)
