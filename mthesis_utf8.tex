...
jsutBasic   & 0.0028 & $1.96\times10^{-4}$ \\
jvs001      & 0.0022 & $5.28\times10^{-4}$ \\
jvs002      & 0.0014 & $3.60\times10^{-4}$ \\
...
After removing 5\%  & 76.55 &	92.50 & \textbf{84.53} \\
After removing 10\% & 73.89 & 81.41 & \textbf{77.65} \\
After removing 15\% & 84.66 & 87.35 & \textbf{86.01} \\
After removing 20\% & 84.23 & 87.62 & \textbf{85.93} \\
After removing 25\% & 79.17 & 83.29 & \textbf{81.23} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
After remove 5\%  & 59.52 & 75.29 & \textbf{67.41} \\
After remove 10\% & 62.58 & 72.41 & \textbf{67.50} \\
After remove 15\% & 57.36 & 71.91 & \textbf{64.64} \\
After remove 20\% & 57.11 & 72.30 & \textbf{64.71} \\
After remove 25\% & 55.82 & 71.57 & \textbf{63.70} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
After removing 5\%  & 58.74 & 73.69 & \textbf{66.22} \\
After removing 10\% & 61.61 & 68.60 & \textbf{65.11} \\
After removing 15\% & 64.12 & 73.48 & \textbf{68.80} \\
After removing 20\% & 61.57 & 69.17 & \textbf{65.37} \\
After removing 25\% & 63.14 & 72.39 & \textbf{67.77} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
After removing 5\%  & 64.08 & 73.57 & \textbf{68.83} \\
After removing 10\% & 59.85 & 76.46 & \textbf{68.16} \\
After removing 15\% & 58.37 & 78.16 & \textbf{68.27} \\
After removing 20\% & 59.63 & 72.07 & \textbf{65.85} \\
After removing 25\% & 62.95 & 75.93 & \textbf{69.44} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
After removing 5\%  & 70.95 & 75.57 & \textbf{73.26} \\
After removing 10\% & 59.56 & 66.74 & \textbf{63.15} \\
After removing 15\% & 65.68 & 75.12 & \textbf{70.40} \\
After removing 20\% & 62.37 & 77.16 & \textbf{69.77} \\
After removing 25\% & 71.63 & 77.22 & \textbf{74.43} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\cmidrule(l{0pt}r{2pt}){1-1}\cmidrule(l{0pt}r{2pt}){2-2}\cmidrule(l{0pt}r{2pt}){3-3}\cmidrule(l{0pt}r{2pt}){4-4}
Baseline          & 67.77 & 78.81 & 73.29 \\
After removing 5\%  & 55.60 & 75.83 & \textbf{65.72} \\
After removing 10\% & 59.94 & 78.41 & \textbf{69.18} \\
After removing 15\% & 57.59 & 74.10 & \textbf{65.85} \\
After removing 20\% & 55.37 & 72.86 & \textbf{64.12} \\
After removing 25\% & 61.45 & 73.79 & \textbf{67.62} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
After removing high stdF0 recordings & \textbf{45.68} & \textbf{37.96} \\
...
\vspace{3mm}
\begin{tabular}{m{3.3cm}|m{8cm}|m{1.7cm}}
\hline
Factor & Data processing & Improve synthetic voices? \\
% \multirow{2}{3cm}{Factor} &
% \multirow{2}{5cm}{Dataset processing} & Effect on synthetic voices: \\
% && improve or not? \\
\cmidrule(l{0pt}r{2pt}){1-1}\cmidrule(l{0pt}r{2pt}){2-2}\cmidrule(l{0pt}r{2pt}){3-3}
...
%-----------------------------------------------------------------
% EVALUATING THE QUALITY OF CROWDSOURCED DATASETS AND PERFORMING DATASET PROCESSING
%-----------------------------------------------------------------

\clearpage
\section{Evaluating the Quality of Crowdsourced Datasets and Performing Dataset Processing}\label{sec_evaluateAndDataCleaning}
